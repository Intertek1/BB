...
WebUI.verifyElementClickable(findTestObject('Page_Beauty Protector Protect  Deta/div_Favorites_listSelector__PC browser'))

WebUI.click(findTestObject('Page_Beauty Protector Protect  Deta/div_Favorites_listSelector__PC browser'))
...
WebUI.verifyTextPresent('0 Products', false)

WebUI.click(findTestObject('Page_Beauty Box Subscription for Wo/div_All My Lists'))
