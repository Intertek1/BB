...
if (WebUI.verifyElementPresent(findTestObject('Page_Beauty Box Subscription for Wo/div_Log In'), 5, FailureHandling.OPTIONAL)) {
    WebUI.click(findTestObject('Page_Beauty Box Subscription for Wo/div_Log In'))
